// Structure inspired by Github:https://github.com/lvreynoso/voiceboxx
...
function autocorrelate(input) {
  ...
  var fft$1 = new fft(np2(2 * input.length));

  // Step 0: pad the input array with zeros.
  var paddedInput = new Array(fft$1.size);
  ...
  var tmp = fft$1.createComplexArray();
  fft$1.realTransform(tmp, paddedInput);
  // We need to fill in the right half of the array too.
  fft$1.completeSpectrum(tmp);
  ...
  var tmp2 = fft$1.createComplexArray();
  fft$1.inverseTransform(tmp2, tmp);
